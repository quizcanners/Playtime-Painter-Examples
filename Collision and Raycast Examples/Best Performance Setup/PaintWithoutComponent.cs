...
#pragma warning disable IDE0018 // Inline variable declaration
    ...
    public class PaintWithoutComponent : MonoBehaviour, IPEGI
    {
        ...
        public void Inspect()
        {
            ...
            if (!continious)
            {
                "Bullets:".PegiLabel(50).edit(ref shoots, 1, 50).nl();
                "Spread:".PegiLabel(50).edit(ref spread, 0f, 1f).nl();
            }
            ...
            if (brush.targetIsTex2D)
            {
                ...
                "Switch to Render Texture".PegiLabel().Click(()=> brush.targetIsTex2D = false);
            }
